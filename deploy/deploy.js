...
var factory_json_1 = __importDefault(require("../compiled/factory.json"));
...
var factory_address = process.env.FACTORY_CONTRACT_ADDRESS || undefined;
function orig() {
    return __awaiter(this, void 0, void 0, function () {
        var factory_store, factory_originated, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    factory_store = {
                        'all_collections': new taquito_1.MichelsonMap(),
                        'owned_collections': new taquito_1.MichelsonMap(),
                        'metadata': new taquito_1.MichelsonMap()
                    };
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    if (!(factory_address === undefined)) return [3 /*break*/, 4];
                    return [4 /*yield*/, Tezos.contract.originate({
                            code: factory_json_1["default"],
                            storage: factory_store
                        })];
                case 2:
                    factory_originated = _a.sent();
                    console.log("Waiting for FACTORY ".concat(factory_originated.contractAddress, " to be confirmed..."));
                    return [4 /*yield*/, factory_originated.confirmation(2)];
                case 3:
                    _a.sent();
